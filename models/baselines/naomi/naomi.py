...
from models.baselines.naomi.naomi_imputer import NAOMIImputer
from models.baselines.naomi.naomi_imputer_alpha import NAOMIImputerAlpha
...
class NAOMI(nn.Module):
    ...
    def forward(self, data, mode="train", teacher_forcing=False, device="cuda:0"):
        ...
        masked_input = masked_input.transpose(0,1) # [bs, time, x_dim] to [time, bs, x_dim]
